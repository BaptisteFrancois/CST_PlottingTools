...
def TwoVarLineplot(array, x_axis, z_dim, title, ylabel, xlabel, colors, caption_labels=None,
                            threshold=None, color_threshold='red', label_threshold='Target', 
                            linewidth=2, figsize=(8, 5), title_fontsize=14, label_fontsize=12, grid=True, 
                            facecolor='whitesmoke', legend_facecolor='whitesmoke', savepath=None, 
                            show=False):

    """
        - array: numpy array. The array to be plotted. The dimensions must be (x_axis, z_dim)
        - x_axis: list. List of the xticks to be plotted
        - z_dim: list. List of the 'array' indices on the y-axis to be plotted
        - title: str. Title of the plot
        - ylabel: str. Label of the y-axis
        - xlabel: str. Label of the x-axis
        - caption_labels: str or None. Label of the captions. This is the label of the lines in the plot that
                        represent the z_dim. If None, no label is plotted
